<%-- 
    Document   : index
    Created on : Nov 28, 2018, 8:38:16 PM
    Author     : ACS
--%>
                ...
                <div class="col-md-6 col-md-offset-3">
                    <div class="panel panel-login">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form id="login-form" action="mclogin.jsp" method="post" role="form" style="display: block;">
                                    ...
                                    <form id="register-form" action="register.jsp" method="post" role="form" style="display: none;">
                                        <div class="form-group">
                                            <input type="text" name="fullname" id="fullname" tabindex="2" class="form-control" placeholder="Full Name"required="required">
                                        </div>
                                        <div class="form-group">
                                            <input type="number" name="age" id="age" tabindex="2" class="form-control" placeholder="Age" required="required">
                                        </div>
                                        <div class="form-group">
                                            <label for="gender" style="font-weight:normal; color: grey;">Gender</label>
                                            ...
                                            <div class="form-group">
                                                <input type="number" name="mobile" id="mobile" tabindex="2" class="form-control" placeholder="Mobile" required="required">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" name="username" id="username" tabindex="1" class="form-control" placeholder="Username" value="" required="required">
                                            </div>
